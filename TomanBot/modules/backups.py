...
import TomanBot.modules.sql.notes_sql as sql
from TomanBot import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from TomanBot.__main__ import DATA_IMPORT
from TomanBot.modules.helper_funcs.chat_status import user_admin
from TomanBot.modules.helper_funcs.alternate import typing_action

# from TomanBot.modules.rules import get_rules
import TomanBot.modules.sql.rules_sql as rulessql

# from TomanBot.modules.sql import warns_sql as warnssql
import TomanBot.modules.sql.blacklist_sql as blacklistsql
from TomanBot.modules.sql import disable_sql as disabledsql

# from TomanBot.modules.sql import cust_filters_sql as filtersql
# import TomanBot.modules.sql.welcome_sql as welcsql
import TomanBot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("TomanBot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("TomanBot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("TomanBot{}.backup".format(chat_id))  # Cleaning file
