...
from TomanBot.modules.helper_funcs.misc import is_module_loaded
from telegram.ext import CallbackContext

FILENAME = __name__.rsplit(".", 1)[-1]

if is_module_loaded(FILENAME):
    from TomanBot import GBAN_LOGS, LOGGER, dispatcher
    from TomanBot.modules.helper_funcs.chat_status import user_admin
    from TomanBot.modules.sql import log_channel_sql as sql
