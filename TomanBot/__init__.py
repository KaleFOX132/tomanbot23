...
if ENV:
    ...
    from TomanBot.config import Development as Config
    TOKEN = Config.TOKEN
...
telethn = TelegramClient("TomanBot", API_ID, API_HASH)
...
from TomanBot.modules.helper_funcs.handlers import (CustomCommandHandler,
