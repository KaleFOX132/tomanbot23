![TomanBot](https://pub-00fa5790a3c142428a65f4a7f2fae1b5.r2.dev/17605146/1668117194636d72ca8341e.jpg)
# Toman Bot 
...
Se puede encontrar en telegram como [TomanBot]("aquí va el link del bot").

Puede comunicarse con el grupo de soporte en [Toman Support](https://t.me/TomanSecurity_bot), donde puede solicitar ayuda sobre q@TomanSecurity_bot, descubrir/solicitar nuevas funciones, informar errores y mantenerse informado cuando sea hay una nueva actualización disponible.

## Cómo configurar/implementar.

### Lea estas notas detenidamente antes de continuar
 - Edite cualquier mención de @TomanSoporte en su propio chat de soporte.
 ...
 - Su código debe ser de código abierto y debe haber un enlace al repositorio de su bifurcación en la respuesta de inicio del bot. [Ver esto](https://github.com/NachABR/TomanBot/blob/f3c76b1c84e14b88a93f3f5a57b4ee748a83c551/TomanBot/__main__.py#L24)
...
Este archivo debe colocarse en su carpeta `TomanBot`, junto con el archivo` __main __. Py`.
