...
import TomanuBot.modules.sql.global_bans_sql as gban_sql
import TomanBot.modules.sql.users_sql as user_sql
from TomanBot import DEV_USERS, OWNER_ID, dispatcher
